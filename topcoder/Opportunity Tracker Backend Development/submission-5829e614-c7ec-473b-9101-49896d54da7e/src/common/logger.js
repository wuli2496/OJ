 ...
 * Log error details
 * @param err the error
 * @param context contains extra info about errors
 */
 ...
 * @params the new object with removed properties
 * @private
 */
  ...
  _.each(service, (method, name) => {
    ...
    service[name] = async function () {
      ...
      logger.debug({
        ...
        context: name,
        message: `input arguments: ${util.inspect(_sanitizeObject(_combineObject(params, args)), {
          compact: true,
