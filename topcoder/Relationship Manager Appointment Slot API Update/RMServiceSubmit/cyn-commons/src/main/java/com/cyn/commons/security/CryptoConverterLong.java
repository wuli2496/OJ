...
@Converter
public class CryptoConverterLong implements AttributeConverter<Long, String> {
   ...
   */
  @Override
  public String convertToDatabaseColumn(Long data) {
    try {
      if (data == null) {
        return null;
      }
      return Base64.getEncoder()
          .encodeToString(
              aesUtils.encryptPKCS5(Long.toString(data).getBytes(), encryptionKey.getBytes()));
    } catch (Exception e) {
